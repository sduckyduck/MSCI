(() => {
  ...
  const PIRATE_ARMOR_BY_SLOT = {
    ...
    Shoes: [
      ...
      { id: 1072297, name: "Brown Locote Shoes", reqLevel: 35, slot: "Shoes" },
      { id: 1072300, name: "Brown Leather Krag", reqLevel: 40, slot: "Shoes" },
      { id: 1072303, name: "Brown Double Boots", reqLevel: 50, slot: "Shoes" },
      { id: 1072306, name: "Black Basile Boots", reqLevel: 60, slot: "Shoes" },
    ],
    Glove: [
